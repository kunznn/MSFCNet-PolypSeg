...
def main():
    ...
    parser.add_argument("--config", default="configs/b05_mobilenetv2unet_kvasir_cvc.yaml")
    ...
    run_name = config.get("run_name") or slugify(config.get("experiment_name", "mobilenetv2unet"))
